...
let GarrettActivityLog = _decorate([e$2('grid-activitylog5b')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      function getMetaConfig() {
        ...
        return {
          controlName: 'grid-activitylog5b',
