...
let NintexSamplegridRepeatingSection = _decorate([e$2('grid-activitylog-sort')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      function getMetaConfig() {
        ...
        return {
          controlName: 'grid-activitylog-sort',
          description: 'Sortable Data Grid for Activity Log by Garrett Fernandez',
