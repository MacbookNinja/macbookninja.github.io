...
let NintexSamplegridRepeatingSection = _decorate([e$2('grid-activitylog-page')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      function getMetaConfig() {
        ...
        return {
          controlName: 'grid-activitylog-page',
          description: 'Data Grid with Pagination for Activity Log by Garrett Fernandez',
      ...
      value: function render() {
        if (this.grid) {
          this.grid.updateConfig({
            ...
            sort: this.sortable,
			pagination: this.pagination ? { limit: 10 } : undefined,
            data: JSON.parse(this.Data)
          });
